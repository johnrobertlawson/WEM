...
# Times in local time...
itime = datetime.datetime(2011,4,19,5,0,0)
ftime = datetime.datetime(2011,4,20,8,0,0)
# Times in UTC...
...
p.plot_radar(radartimes,datadir,outdir,compthresh=radarthresh,
                composite=True,fig=fig,ax=ax,**lims)

# Storm reports
SR = StormReports(fpath)
SR.plot('Wind',itime,ftime,fname,outdir,ax=ax,fig=fig,ss=8,**lims)
