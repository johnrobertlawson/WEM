...
stoch_ens = ["s{0:02d}".format(n) for n in range(1,11)]
...
# for s in members:
fpath = os.path.join(config.wrfout_root,case,IC,ens)
path_to_wrfouts = p.wrfout_files_in(fpath,dom=1,avoid=stoch_ens)
